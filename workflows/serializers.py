...
class WidgetSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def get_icon(self, widget):
        ...
        icon_path = 'special-icons/question-mark.png'
        ...
        if widget.abstract_widget:
            if widget.abstract_widget.static_image:
                ...
                icon_path = 'special-icons/ws.png'
        elif hasattr(widget, 'workflow_link'):
            icon_path = 'special-icons/subprocess.png'
        elif widget.type == 'input':
            icon_path = 'special-icons/forward-arrow.png'
        elif widget.type == 'output':
            icon_path = 'special-icons/forward-arrow.png'
        elif widget.type == 'output':
            icon_path = 'special-icons/loop.png'
