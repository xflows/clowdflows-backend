...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workflows_recommender', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='input', to=orm['workflows.AbstractInput'])),
            ('out', self.gf('django.db.models.fields.related.ForeignKey')(related_name='output', to=orm['workflows.AbstractOutput'])),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('workflows', ['Recommender'])


    def backwards(self, orm):
        # Deleting model 'Recommender'
        db.delete_table('workflows_recommender')
    ...
    models = {
        ...
        'workflows.recommender': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inp': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'input'", 'to': "orm['workflows.AbstractInput']"}),
            'out': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'output'", 'to': "orm['workflows.AbstractOutput']"})
        },
